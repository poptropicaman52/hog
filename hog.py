...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    ree = player_score % 10
    bee = opponent_score % 10
    raa = player_score // 10
    baa = opponent_score // 10
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    #stategy0 = lambda score0, score1: score1 % 10
    #strategy1 = lambda score1, score0: score1 // 10 - 2
    #strategy0 = 1
    #strategy1 = 1
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        return announce_highest(who, high, baba)
    return say
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(score, opponent_score):
        ...
        if my_score - score >= margin:
            return 0
        else:
            return num_rolls
    elif free_bacon(opponent_score):
        my_score = free_bacon(opponent_score) + score
        if is_swap(my_score, opponent_score):
            my_new_score = opponent_score
            opponent_new_score = my_score
            if my_new_score - score + opponent_score - opponent_new_score >= margin:
                return 0
            else:
                return num_rolls
        elif my_score - score >= margin:
            return 0
        else:
            return num_rolls
    else:
